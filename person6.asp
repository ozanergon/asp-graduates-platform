...
<div class="sosyal">
		...
		<div>
		<div class="kutu">
		<h1 class="title2"><center>Elif Kanca</center></h1>
			
		<div style="margin:25px 0px">
			<img width="400" height="555" style="margin-left:630px;" src="Resimler/elif_kanca1.jpg" />
		</div>
...
%>				
			...
			<form action="verigirisiperson6.asp" method="post"style="margin-left:870px;">
