...
<div class="sosyal">
		...
		<div style="margin:25px 120px">
			<img width="600" height="450" usemap="#link" style="margin-left:520px;" src="Resimler/toplu2.jpg" />
			<map name="link">
			    	<area shape="circle" title="Aşıt Aslan" coords="112,135,10" href="person3.asp">
			    	<area shape="circle" title="Emrah Eroğlu" coords="392,192,15" href="person5.asp">
			    	<area shape="circle" title="Yusuf Küçükkara" coords="330,158,15" href="person2.asp">
			    	<area shape="circle" title="Elif Kanca" coords="160,163,13" href="person6.asp">
			    	<area shape="circle" title="Kübra Aydın" coords="270,142,15" href="person1.asp">
					<area shape="circle" title="Şule Yağmur" coords="128,182,15" href="person4.asp">
			</map>
		</div>
...
%>		
			...
			<form action="verigirisiphoto2.asp" method="post" style="margin-left:850px;">
