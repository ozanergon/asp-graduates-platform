...
<div class="sosyal">
		...
		<div>
		<div class="kutu">
		<h1 class="title2"><center>Yusuf Küçükkara</center></h1>
			
		<div style="margin:25px 0px">
			<img width="400" height="400" style="margin-left:620px;" src="Resimler/yusuf_kucukkara1.jpg" />
		</div>
...
%>				
			...
			<form action="verigirisiperson2.asp" method="post" style="margin-left:850px;>
