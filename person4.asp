...
<div class="sosyal">
		...
		<div>
		<div class="kutu">
		<h1 class="title2"><center>Şule Yağmur Kara</center></h1>
			
		<div style="margin:25px 0px">
			<img width="250" height="444"  style="margin-left:690px;" src="Resimler/sule_yagmur1.jpg" />
		</div>
...
%>	
			...
			<form action="verigirisiperson4.asp" method="post" style="margin-left:870px;">
