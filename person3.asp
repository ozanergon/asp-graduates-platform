...
<div class="sosyal">
		...
		<div>
		<div class="kutu">
		<h1 class="title2"><center>Aşıt Aslan</h1>
			
		<div style="margin-left:600p;">
			<img width="400" height="400" style="margin-left:620px;" src="Resimler/asit_aslan1.jpg" />
		</div>
		<div style="margin:25px 0">
			
			<table border="2px" cellpadding="1px" cellspacing="0px" style="margin-left:720px;">
				<tr >
					<td><b>Ne Zaman?</b></td>
					<td><b>Kim?</b></td>
...
%>	
			...
			<form action="verigirisiperson3.asp" method="post" style="margin-left:870px;>
