...
<div id="page">
 	...
 	<div id="sagdiv">
		...
		<div id="content">
		<div class="kutu">
		<h1 class="title2">Fotoğraflar (12.Sınıf Okul Birinciliği)</h1>
			
		<div style="margin:25px 120px">
			<img width="410"  src="images/photos/04.jpg" />
		</div>
...
%>		
			...
			<form action="verigirisiphoto4.asp" method="post">
