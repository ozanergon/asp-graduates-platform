...
<div class="sosyal">
		...
		<div>
		<div class="kutu">
		<h1 class="title2"><center>Kübra Aydın</center></h1>
			
		<div style="margin:25px 0px">
			<img width="250" height="444" style="margin-left:700px;" src="Resimler/kubra_aydin1.jpg" />
		</div>
...
%>				
			...
			<form action="verigirisiperson1.asp" method="post"style="margin-left:870px;">
